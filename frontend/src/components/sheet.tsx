...
export const Sheet = () => {
	...
	return (
		<div
			className={`w-[580px] flex flex-col justify-between p-5 h-screen bg-[#1b1b1b] z-20 absolute right-0`}
		>
			<div>
			...
			<div className="flex justify-between px-15 mb-5">
				<button className="border border-[#df8f60] px-8 py-2 rounded-2xl text-[19px]">
					Esvaziar Carrinho
				</button>
